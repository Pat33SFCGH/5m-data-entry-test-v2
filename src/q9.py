...
# Step 5 — Push `my-solutions` to the remote: git push --set-upstream origin my-solutions
...
and which command moves a file from there into the next commit?
    ...
    Answer: It did not commit the modified file. git commit -m "Staged for commit"
"""
