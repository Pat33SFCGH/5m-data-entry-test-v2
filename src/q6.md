...
**Reason 1:**  
_B tell AI what is it roles which will able to generate the information accordingly_

**Reason 2:**  
_B tell AI what to do from beginning to end in a very specific information like the roles, what is the target audience, what data to populate etc._
...
> **Role:** You are a data analyst helping a retail marketing team.  
> **Task:** Analyse customer online survey data from a 3-month campaign spreadsheet.  
> **Data:** 500 responses containing age group, product purchased, satisfaction rating (1-5), and written comments.  
> **Steps:**
> 1. Identify age groups and products with the lowest satisfaction scores.
...
>
> **Audience:** CEO presentation on Friday.  
> **Constraints:** Keep the summary in short paragraph and free of grammar error.
_

**What you borrowed and why:**  
_I had borrowed online and spreadsheet from A and add it in B Task. This is to inform the AI that the data is from a spreadsheet where the data is input from online. I had borrowed complaint from A and changed the theme in B Step 2. There is to inform the AI there is a mistake on it and it should be complaints instead of theme. I had borrowed short paragraph from A and use it in B Constraints. This is to inform AI to keep the summary findings in short paragraph_
